...
import { RAW_INVENTORY_DETAILS_ROLES } from "../../../../constants/pageRoles";
...
const RawInventoryDetails = ({}: Props) => {
	//role access control start
	const { data: meData } = useMeQuery();
	const allowed = isUserAllowed({
		allowedRoles: RAW_INVENTORY_DETAILS_ROLES,
...
export default RawInventoryDetails;
